...
export class RuleEditorModal extends Modal {
  ...
  onOpen(): void {
    ...
    this.resolverSectionEl = contentEl.createDiv({ cls: 'structural-properties-subsection' });
    this.renderResolverSection();
    ...
    this.formatSectionEl = contentEl.createDiv({ cls: 'structural-properties-subsection' });
    this.renderFormatSection();
